...
namespace Unity.Assets.Scripts.Data
{
    ...
    public class DataLoader : IStartable
    {
        ...
        public Dictionary<int, Data.PhysicsObjectData> PhysicsObjectDic { get; private set; } = new Dictionary<int, Data.PhysicsObjectData>();
        ...
        public void Init()
        {
            ...
            PhysicsObjectDic = LoadJsonToResoureManager<Data.PhysicsObjectDataLoader, int, Data.PhysicsObjectData>("PhysicsObjectData").MakeDict();
