...
namespace Unity.Assets.Scripts.Data
{
	...
	[Serializable]
    public class PhysicsObjectDataLoader : ILoader<int, PhysicsObjectData>
    {
        public List<PhysicsObjectData> physicsObjects = new List<PhysicsObjectData>();
        public Dictionary<int, PhysicsObjectData> MakeDict()
        {
            Dictionary<int, PhysicsObjectData> dict = new Dictionary<int, PhysicsObjectData>();
            foreach (PhysicsObjectData physicsObject in physicsObjects)
                dict.Add(physicsObject.DataId, physicsObject);
            return dict;
        }
    }
    ...
    #region 공 데이터
    [Serializable]
    public class BallData : GameObjectData
    {
        // 기본 속성
		...
		public float bounceImpactThreshold;
